...
<head>
    ...
    <title>Editar/Eliminar Productos</title>
    <link rel="shortcut icon" type="image/x-icon" href="Imagenes/Icono.png">
    <link rel="stylesheet" type="text/css" href="Estilos_Acceso_Denegado.css">
    <link rel="stylesheet" type="text/css" href="Estilos_Editar_Eliminar_Productos_13.css">
            ...
            <div class="container_select_buscador">
                ...
                <div class="container-fluid">
                    <input type="text" required onkeypress="return Enter(this, event, 'NO', 'LET-NUM')" name="campo"
                        id="campo" placeholder="Buscar Producto" class="form-control me-2">
                </div>
