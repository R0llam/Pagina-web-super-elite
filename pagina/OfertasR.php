...
<head>
    ...
    <title>Ofertas más Reservadas</title>
    <link rel="shortcut icon" type="image/x-icon" href="Imagenes/Icono.png">
    <link rel="stylesheet" type="text/css" href="Estilos_Ofertas_mas_Reservadas.css">
