...
<body>
    ...
    <h1 class="Titulo_P">Registro de Marcas</h1>
    ...
    <div class="Container_all">
        ...
        <div class="Contenedor_registro">
            <section class="Registro">
                ...
                <form name="Categoria" action="Marca2.php" method="post" enctype="multipart/form-data">

                    <label for="NombreP">Nombre:<input class="controles" type="text" name="NombreP" id="NombreP"
                            onkeypress="return Enter(this, event, 'NO', 'LET-NUM')" required="obligatorio"
                            maxlength="50" placeholder="Escribe el nombre de la Marca " /></label>
        ...
        <div class="container_table">
            ...
            <h1 class="titulo_tabla">Marcas Registradas</h1>
            ...
            <div class="table-responsive">
				...
				?>
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-danger' href="eliminarMarca.php?id=<?php echo $id?>">Eliminar</a>
                            </td>
                        </tr>
                        <?php
			}
