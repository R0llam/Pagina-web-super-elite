...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Estilos_Administracion_Curriculos_12.css">
            ...
            <div class="container_select_buscador">
                ...
                <div class="container-fluid">
                    <input type="text" required onkeypress="return Enter(this, event, 'NO', 'LET-NUM')" name="campo"
                        id="campo" placeholder="Buscar Currículo" class="form-control me-2">
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-secondary table-bordered table_id" id="tblDatos">
                        <thead class="table-dark">
                            ...
                            <th class="sort asc"><img src="assets\arrow-down-up.svg" class="ordenar_img">Nombre del
                                Archivo</th>
                            <th class="sort asc"><img src="assets\arrow-down-up.svg" class="ordenar_img">Usuario</th>
                            <th class="sort asc"><img src="assets\arrow-down-up.svg" class="ordenar_img">Archivo</th>
