        ...
        if ($num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                if($row['estado'] == 'Completada'){
                    $output['data'] .= '<td><a class="btn btn-primary" href="Reservas_usuario_completadas.php?id='.$row['Referencia'].'">Detalles</a></td>';
                }
                else{
                    $output['data'] .= '<td>
                        <a class="btn btn-primary" href="Detalles_Reserva_Usuario.php?id='.$row['Referencia'].'">Detalles</a>
                        <a class="btn btn-danger" href="Administracion_de_reservas_E.php?id='.$row['Referencia'].'&referencia='.$row['Referencia'].'">Cancelar</a>
                    </td>';
                }
                $output['data'] .= '</tr>';
            }
