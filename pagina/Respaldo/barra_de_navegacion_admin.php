    ...
    <section class="menu_contenedor">
        ...
        <ul class="menu_links">
            ...
            <li class="menu_item menu_item--show">
                <a href="#" class="menu_link">Reservas<img src="assets/arrow.svg" class="menu_arrow"></a>
                ...
                <ul class="menu_nesting">
                    ...
                    <li class="menu_inside">
                        <a href="../Administracion_de_reservas_C2.php" class="menu_link menu_link--inside">Completadas</a>
                    </li>
                    <li class="menu_inside">
