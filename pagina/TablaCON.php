<?php
        ...
        $columns = ['IDC', 'Telefono', 'Asunto', 'Mensaje', 'ID'];
        ...
        if ($num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                $output['data'] .= '<td>' . $row['IDC'] . '</td>';
                $output['data'] .= '<td>' . $Nombre . '</td>';
                $output['data'] .= '<td>' . $Apellido . '</td>';
                $output['data'] .= '<td>' . $Correo . '</td>';
                $output['data'] .= '<td>' . $row['Telefono'] . '</td>';
                $output['data'] .= '<td>' . $row['Asunto'] . '</td>';
                $output['data'] .= '<td>' . $row['Mensaje'] . '</td>';
                $output['data'] .= "<td>
                                        <a class='btn btn-danger' href='eliminar_C.php?id=$idp'>Eliminar</a>
                                    </td>";
                $output['data'] .= '</tr>';
            }
        } else {
