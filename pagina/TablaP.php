<?php
        ...
        $columns = ['ID_P', 'NombreP', 'Cantidad', 'archivoBLOB', 'Fecha_de_vencimiento_P'];
        ...
        if ($num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                $output['data'] .= '<td>' . $row['Fecha_de_vencimiento_P'] . '</td>';
                $output['data'] .= "<td><img class='card-img' height='100' src='../Productos/$archivo' class='card-img'></img></td>";
                $output['data'] .= "<td>
                                        <a class='btn btn-danger' href='eliminar2.php?id=$idp'>Eliminar</a>
                                        <a class='btn btn-primary' href='Editar2.php?id=$idp'>Editar</a>
                                    </td>";
                $output['data'] .= '</tr>';
            }
        } else {
