...
<head>
    ...
    <title>Productos más Reservados</title>
    <link rel="shortcut icon" type="image/x-icon" href="Imagenes/Icono.png">
    <link rel="stylesheet" type="text/css" href="Estilos_Productos_mas_Reservados.css">
...
<body>
    ...
    <h1>Productos más Reservados</h1>
                ...
                <div class="table-responsive">
                    <table class="table table-secondary table-bordered table_id">
                        <thead class="table-dark">
                            ...
                            <th class="sort asc"><img src="assets\arrow-down-up.svg" class="ordenar_img">Cantidad de
                                Reservas</th>
