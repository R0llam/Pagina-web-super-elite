...
<body style="background-color: #26292e;">
                ...
                if(isset($_SESSION['carrito'])){
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; text-align: center;">
                            ...
                            <?php echo $carrito_m[$i]['Precio_B'] ?>Bs
                        </td>
                        <td style="vertical-align: middle; text-align: center;">
    ...
    <hr style="width: 89%; max-width: 1200px; margin: auto; margin-top: 50px;">
...
?>
    ...
    <div class="container p-5">
        <form class="row g-3 needs-validation" action="reserva3.php" method="POST" novalidate>
            ...
            <div class="cotenedor_input">
                ...
                <div class="col-md-6">
                    ...
                    <input type="hidden" class="form-control" id="validationCustom01" name="nombre"
                        required="obligatorio" value="<?php echo $Nombre; ?>" />
