...
<body>
    ...
    <h1 class="Titulo_P">Registro de Sucursales</h1>
    ...
    <div class="Container_all">
        ...
        <div class="Contenedor_registro">
            <section class="Registro">
                ...
                <form name="Categoria" action="Sucursal2.php" method="post" enctype="multipart/form-data">
                    ...
                    <label for="NombreP">Nombre:<input class="controles" type="text" name="NombreP" id="NombreP"
                            ...
                            placeholder="Escribe el nombre de la Sucursal " /></label>
        ...
        <div class="container_table">
            ...
            <h1 class="titulo_tabla">Sucursales Registradas</h1>
            ...
            <div class="table-responsive">
				...
				?>
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-danger' href="eliminarSucursal.php?id=<?php echo $id?>">Eliminar</a>
                            </td>
                        </tr>
                        <?php
			}
