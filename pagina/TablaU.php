<?php
        ...
        $columns = ['ID', 'usuario', 'contrasena', 'Correo_Electronico'];
        ...
        if ($num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                if ($idp=='1'){
                    ...
                    $output['data'] .= '<td><a class="btn btn-danger">Eliminar</a></td>';  
   
                }else{

                    $output['data'] .= "
                    <td>
                        <a class='btn btn-danger' href='eliminarU.php?id=$idp'>Eliminar</a>
                    </td>";
                }
                $output['data'] .= '</tr>';
            }
