...
if($r <= 3){
    ...
    $Banco= $_POST['Banco'];
    $Comprobante= $_POST['Referencia'];
    $query = "INSERT INTO pedido_cp (Referencia,ID,estado,total,total2,Fecha_R,Fecha_RL,Tipo_pedido_ID,ID_Sucursal,ID_Cuenta_Bancaria,Comprobante_cp) VALUES ('$ref', '$ref_user', '$estado', '$total_pedido', '$total_pedido2', '$fecha','$fecha2','$tipo','$sucursal','$Banco','$Comprobante')";
    $result = mysqli_query($conexion,$query);
