<?php 
	...
	$message= '';
		...
		$conexion= conexion();
		$query= insertar_Sucursal($conexion,$Nombre);
		
			if ($query) {
			$message= 'Registro Exitoso';
			$message2= 'Sucursal registrada de manera correcta';
			}
			else{
...
<head>
    ...
    <title>Administración de Sucursal</title>
</head>
    ...
    <div class="modal">
        <div class="modal_container">
            ...
            <div class="container_btn">
                <a href="Sucursal.php" class="btn-modal btn-secondary">Cerrar</a>
            </div>
            <?php }else{?>
