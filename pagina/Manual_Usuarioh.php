...
<body>
    ...
    <div class="container">
        ...
        <div class="Introduccion">
            ...
            <p>Esta es una página web comercial que tiene como objetivo el mostrar los distintos productos encontrados
                en nuestro local así como sus precios, también fue desarrollada para permitirte solicitar empleo por
                medio de ella, a continuación se te explicara cómo hacerlo y como funciona cada apartado de nuestra
                página.</p>
        </div>
        ...
        <div class="Antes_de_Iniciar_Sesion">
            ...
            <p>Para poder acceder a las distintas opciones de la página, como por ejemplo solicitar empleo, necesitaras
                iniciar sesión, para lo cual primero tendrás que registrarte con un usuario y contraseña.</p>
            <div class="imagen_secudaria">
        ...
        <div class="Antes_de_Iniciar_Sesion">
            ...
            <p>En este apartado podrás registrar tus datos para crear un usuario y contraseña que te servirán acceder a
                todos los módulos de la página.</p>
            <div class="imagen_secudaria">
        ...
        <div class="Antes_de_Iniciar_Sesion">
            ...
            <p>En esta zona encontraras todas las categorías de los productos de nuestro local donde podrás seleccionar
                la categoría de tu preferencia, para así ver los distintos productos que se encuentran en ella, así como
                también sus precios.</p>
            <div class="imagen_secudaria">
        ...
        <div class="Antes_de_Iniciar_Sesion">
            ...
            <p>En este apartado podrá conocer un poco más sobre la historia de nuestro local, de igual forma conocerá
                nuestra visión y misión, y la localización del local en el municipio.</p>
            <div class="imagen_secudaria">
        ...
        <div class="Antes_de_Iniciar_Sesion">
            ...
            <p>Aquí podrás darnos tu opinión sobre la página, así como también poder reportar cualquier fallo que la
                misma pueda tener.</p>
            <div class="imagen_secudaria">
        ...
        <div class="Despues_de_Iniciar_Sesion">
            ...
            <p>Al momento de iniciar sesión podrás realizar un pedido mediante los módulos de productos y ofertas
                presionando el botón que se muestra en la imagen </p>
            <div class="imagen_secudaria">
                <img class="Imagen_Enviar_Curriculo_2" src="Imagenes/Manual/10.PNG">
            </div>
            <p>Para continuar el pedido se debe de presionar el botón que se muestra en la imagen anterior y presionar
                el botón de continuar.</p>
        </div>
        ...
        <div class="Despues_de_Iniciar_Sesion">
            ...
            <p>Aquí podrás solicitar empleo enviando tu currículo en formato PDF, para ello el nombre del archivo tiene
                que ser de la siguiente forma: (Nombre_Apellido.pdf).</p>
            <div class="imagen_secudaria">
        ...
        <div class="Cerrar_Sesion">
            ...
            <p>Al pulsar esta opción saldrás del sistema y por lo tanto tu sesión quedará cerrada hasta que vuelvas a
                acceder por medio de tu usuario y contraseña.</p>
        </div>
        ...
        <div class="Regresar">
            <a href="Ayudah.php">Regresar a la Página Anterior.</a>
        </div>
    </div>
